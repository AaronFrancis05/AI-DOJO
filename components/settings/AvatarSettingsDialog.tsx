/* ───────────────────────────────────────────────
   AvatarSettingsDialog — avatar & AI voice preferences
   as a dialogue section over /settings (was a page route).
   ─────────────────────────────────────────────── */
...
export function AvatarSettingsDialog({ open, onClose }: AvatarSettingsDialogProps) {
  ...
  return (
    <Dialog open={open} onClose={onClose} size="xl" title="Avatar & Character" label="Avatar & Character settings">
