...
const characterFixtures = [
  { name: 'Yuki Tanaka', role: 'Friendly Shopkeeper / Waitress', personality: 'Patient and encouraging', avatarColor: '#2D3BC5', avatarIcon: 'Smile', voiceType: 'Warm, Female — Mid Pitch', avatarModelUrl: '/ai-avatars/Yuki-Tanaka.glb', displayOrder: 1 },
  { name: 'Kenji Sato', role: 'Business Executive / Hotel Manager', personality: 'Professional yet warm', avatarColor: '#D14343', avatarIcon: 'UserCheck', voiceType: 'Calm, Male — Low Pitch', avatarModelUrl: '/ai-avatars/KenjiSato.glb', displayOrder: 2 },
  { name: 'Miyuki Nakamura', role: 'Customer Service / Nurse', personality: 'Efficient and friendly', avatarColor: '#2FAE66', avatarIcon: 'Smile', voiceType: 'Clear, Female — Mid-High Pitch', avatarModelUrl: '/ai-avatars/Miyuki-Nakamura.glb', displayOrder: 3 },
  { name: 'Takeshi Yamamoto', role: 'Train Conductor / Police Officer', personality: 'Serious but approachable', avatarColor: '#E3A939', avatarIcon: 'UserCheck', voiceType: 'Authoritative, Male — Mid Pitch', avatarModelUrl: '/ai-avatars/Takeshi-Yamamoto.glb', displayOrder: 4 },
  { name: 'Hana Kimura', role: 'Fashion Assistant / Tour Guide', personality: 'Friendly and cheerful', avatarColor: '#9333EA', avatarIcon: 'Star', voiceType: 'Warm, Female — Mid Pitch', avatarModelUrl: '/ai-avatars/Hana-Kimura.glb', displayOrder: 5 },
  { name: 'Ryo Aoki', role: 'Airline Staff / Hotel Concierge', personality: 'Efficient and professional', avatarColor: '#06B6D4', avatarIcon: 'Headphones', voiceType: 'Clear, Male — Mid Pitch', avatarModelUrl: '/ai-avatars/Ryo-Aoki.glb', displayOrder: 6 },
  { name: 'Takashi Mori', role: 'Business Executive / Corporate Professional', personality: 'Punctual and professional', avatarColor: '#2563EB', avatarIcon: 'UserCheck', voiceType: 'Calm, Male — Low Pitch', avatarModelUrl: '/ai-avatars/Takashi-Mori.glb', displayOrder: 7 },
  { name: 'Sakura Yamada', role: 'Friendly Neighbour / Local Guide', personality: 'Warm and approachable', avatarColor: '#F59E0B', avatarIcon: 'Smile', voiceType: 'Warm, Female — Mid Pitch', avatarModelUrl: '/ai-avatars/Sakura-Yamada.glb', displayOrder: 8 },
];
